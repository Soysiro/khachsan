...
DefaultTableModel tblModel;
    ...
    try {
     ...
     private void loadData1(){
        try{
            tblModel = new DefaultTableModel();
            tblModel.setColumnIdentifiers(new String[]{"ID","Name","Date of birth","Phone","ID card","Address","Position"});
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(971, 648));
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(971, 648));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 300, 870, 350));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/icons8_staff_70px.png"))); // NOI18N
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 100, 570));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 300, 870, 350));
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        this.positon.setVisible(true);
        this.roomnumber.setVisible(false);
        this.bed1.setVisible(false);
        this.views.setVisible(false);
        this.roomtype.setVisible(false);
